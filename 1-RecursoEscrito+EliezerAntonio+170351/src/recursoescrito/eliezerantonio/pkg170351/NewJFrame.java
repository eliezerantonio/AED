...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(  jTextField1.getText().equals("Admin") &&  jTextField2.getText().equals("1234") )   {
          JOptionPane.showMessageDialog(null, "Login Administrador");
       }    
       else if(jTextField1.getText().equals("user") &&  jTextField2.getText().equals("1234")){
              JOptionPane.showMessageDialog(null, "Login não Administrador"); 
       }
       else{
